...
class AutonomousEngineeringTests(unittest.TestCase):
    ...
    def test_dry_run_objective_approval_gates_and_persistence(self) -> None:
        ...
        self.assertIn("Packages/packages-lock.json", detail.simulations[0].projected_dependency_changes)
        self.assertIn("ProjectSettings/ProjectSettings.asset", detail.simulations[0].projected_dependency_changes)
        self.assertIn("Assets/Scripts/Gameplay.asmdef", detail.simulations[0].projected_dependency_changes)
