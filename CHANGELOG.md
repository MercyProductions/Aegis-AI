...
- Hardened shared Ollama URL settings so common local URLs are normalized and malformed URLs report model health failures instead of breaking diagnostics.
