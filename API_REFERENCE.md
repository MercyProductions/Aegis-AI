...
- Settings updates persist sanitized hybrid routing values to `.aegis/config.json`, including canonical routing modes, provider IDs, model lists, context limits, booleans, and local HTTP(S) provider URLs.
