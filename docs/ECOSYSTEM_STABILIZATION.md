...
| VS Code diagnostics | Improved | Local API HTTP failures now surface parsed, redacted details instead of raw JSON response bodies, and blocked proposal warnings/errors name the first unsafe file instead of hiding the path in the output channel. |
